...
//
// Add Image CTA occupying an empty collection slot in the editor — OptionList's
// state ladder (rest ▸ hover ▸ active ▸ keyboard focus) scaled up to a grid
// cell (Figma 828:6860 light / 827:6511 dark).
