...
export function CommandPalette() {
  ...
  // The chip names the key this visitor's keyboard actually has — ⌘J on Apple
  // hardware, Ctrl J on a PC — which is the same shortcut the hook listens for
  // on each. It was ⌘[ until Safari turned out never to hand that one over.
  const backShortcut = useShortcutLabel("J");
