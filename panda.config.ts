  ...
  theme: {
    ...
    extend: {
      ...
      slotRecipes: {
        ...
        // -------------------------------------------------------------------
        weatherGraphic: defineSlotRecipe({
        ...
        weatherWidget: defineSlotRecipe({
